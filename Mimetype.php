...
/**
 * Pyro\Email\Mimetype.php
 *
 * A simple class to find the content type / mimetype
...
{
    /**
     * In most cases, if the correct content type could
     * not be found, than returning this will be sufficient.
     */
